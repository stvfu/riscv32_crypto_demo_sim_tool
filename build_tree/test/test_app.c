...
static void test_ecdsa_sign(void)
{
    ...
    char au8Sig_S[32]={0};
    int hash_type = 0;
    sec_ecdsa_sign(au8EccPrivateKey_D,
                   au8EccPublicKey_Q_X,
                   au8EccPublicKey_Q_Y,
                   (char*)au8Message,
                   (int)sizeof(au8Message),
...
static void test_ecdsa_verify(void)
{
    ...
    char au8Sig_R[32]=
    {
        0xAD, 0xEF, 0xA3, 0xBC, 0x6A, 0xB6, 0xF9, 0xF4, 0x77, 0xE6, 0x04, 0x1D, 0xE5, 0x93, 0x64, 0x75,
        0xE3, 0x3C, 0x88, 0x29, 0xEF, 0x65, 0xDC, 0x53, 0x3A, 0x28, 0x53, 0xCA, 0x20, 0x7D, 0xD9, 0xF2
    };

    char au8Sig_S[32]=
    {
        0x8B, 0xF3, 0x14, 0x83, 0xC4, 0xBE, 0xB1, 0x13, 0x40, 0x8B, 0xF8, 0x0E, 0xDB, 0x85, 0x04, 0x9C,
        0x55, 0x30, 0xEE, 0xEC, 0x60, 0xBE, 0x90, 0xD5, 0xD5, 0xFB, 0x08, 0x75, 0x0C, 0x73, 0x28, 0xAA
    };
    ...
    int hash_type = 0;
    sec_ecdsa_verify(au8EccPublicKey_Q_X,
                     au8EccPublicKey_Q_Y,
                     (char*)au8Message,
                     (int)sizeof(au8Message),
                     (char*)au8Sig_R,
