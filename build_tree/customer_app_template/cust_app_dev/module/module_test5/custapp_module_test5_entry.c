...
void custapp_module_test5_execute(uint32_t u32Address, uint32_t u32Size)
{
    ...
    // parser
    E_Custapp_Module_Test5_CmdId eCmdId = (E_Custapp_Module_Test5_CmdId)stCustappReqData.u32CustappCmd;
