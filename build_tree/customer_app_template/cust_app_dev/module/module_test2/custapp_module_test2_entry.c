...
void custapp_module_test2_execute(uint32_t u32Address, uint32_t u32Size)
{
    ...
    // parser
    E_Custapp_Module_Test2_CmdId eCmdId = (E_Custapp_Module_Test2_CmdId)stCustappReqData.u32CustappCmd;
