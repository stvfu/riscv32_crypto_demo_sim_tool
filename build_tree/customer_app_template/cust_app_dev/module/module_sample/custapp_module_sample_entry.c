...
void custapp_module_sample_execute(uint32_t u32Address, uint32_t u32Size)
{
    ...
    // parser
    E_Custapp_Module_Sample_CmdId eCmdId = (E_Custapp_Module_Sample_CmdId)stCustappReqData.u32CustappCmd;
