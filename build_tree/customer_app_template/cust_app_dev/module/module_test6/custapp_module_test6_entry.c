...
void custapp_module_test6_execute(uint32_t u32Address, uint32_t u32Size)
{
    ...
    // parser
    E_Custapp_Module_Test6_CmdId eCmdId = (E_Custapp_Module_Test6_CmdId)stCustappReqData.u32CustappCmd;
